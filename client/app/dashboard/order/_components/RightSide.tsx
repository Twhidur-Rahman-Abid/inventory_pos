...
const carts = [
  ...
  { id: 2, name: "Banana", quantity: 1, price: 30 },
];
...
const RightSide = () => {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          `w-[80vw] absolute  z-20  top-4 transition-all ease-in-out duration-300 xl:static sm:min-w-fit sm:w-fit xl:block max-h-fit bg-white shadow-1 p-6 2xl:p-10 -translate-y-4  md:-translate-y-8 space-y-10`,
          {
      ...
      >
        ...
        <div className="flex-between">
          ...
          <div className="flex gap-5 items-center">
            ...
            <button className="flex gap-5 border-0  text-md font-semibold text-secondary  justify-center items-center p-1.25 bg-[#F3FAF7] text-sm rounded-sm cursor-pointer">
              Clear
            </button>
          </div>
        </div>
        ...
        {/* Summary */}
        <BillingSummary />
        <Button onClick={() => setIsPaymentOpen(true)}>Pay {total} ৳</Button>
      </div>
...
function CartTableRow({ data = {} }) {
  return (
    <tr>
      {/* Product Name */}
      <Td className="whitespace-nowrap p-3.5 truncate">Sample Product</Td>

      {/* Quantity */}
      <Td className="whitespace-nowrap p-3.5 text-center min-w-30">
        <div className="flex gap-4 justify-center items-center">
          <Icon src="/icon/i-minus.svg" size={14} />
          ...
          <Icon src="/icon/i-plus-border.svg" size={14} />
        </div>
      </Td>

      {/* Price */}
      <Td className="whitespace-nowrap p-3.5">100.00</Td>

      {/* Delete */}
      <Td className="mx-auto">
        <Icon src="/icon/i-delete.svg" />
      </Td>
    </tr>
  );
}
